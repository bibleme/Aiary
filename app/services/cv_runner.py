...
def siglip_embedding(models: dict[str, Any], img_pil: Image.Image, box: list[float]) -> list[float]:
...
def detect_objects(models: dict[str, Any], image_path: Path, img_pil: Image.Image) -> list[dict]:
